        ...
        <div class="sidebar">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                @if(Auth::user())
                    @if(session('idRole'))
                        @if (session('idRole')==1)
                            <li><a class="font-semibold text-red-300" href="{{ route('usuarios.index') }}">Usuarios</a></li>
                            <li><a class="font-semibold text-red-300" href="{{ route('firmas.index') }}">Pymes</a></li>
                            <li><a class="font-semibold text-red-300" href="{{ route('personas.index') }}">Personas</a></li>
                            <li><a class="font-semibold text-red-300" href="{{ route('pymes.mysmes') }}">Solicitudes</a></li>
